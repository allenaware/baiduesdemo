...
class AdvertiserQueryQualificationService extends Baidu_Api_Client_Core {
	public function __construct() {
		parent::__construct('/advertiser/queryQualification');
	}
}

// New service
$service = new AdvertiserQueryQualificationService();
